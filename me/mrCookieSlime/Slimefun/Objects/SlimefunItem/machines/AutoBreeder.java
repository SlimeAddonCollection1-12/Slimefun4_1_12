...
/*     */     
/*  40 */     new BlockMenuPreset(name, "&6自动喂养器")
/*     */       {
/*     */         public void init()
/*     */         {
/*  44 */           AutoBreeder.this.constructMenu(this);
/*     */         }
/*     */ 
/*     */ 
/*     */         
...
/*  58 */           if (flow.equals(ItemTransportFlow.INSERT)) return AutoBreeder.this.getInputSlots(); 
/*  59 */           return new int[0];
/*     */         }
/*     */       };
/*     */     
...
/*  72 */             me.mrCookieSlime.Slimefun.holograms.AutoBreeder.getArmorStand(b).remove();
/*  73 */             BlockMenu inv = BlockStorage.getInventory(b);
/*  74 */             if (inv != null) {
/*  75 */               for (int slot : AutoBreeder.this.getInputSlots()) {
...
/* 137 */     for (Entity n : me.mrCookieSlime.Slimefun.holograms.AutoBreeder.getArmorStand(b).getNearbyEntities(4.0D, 2.0D, 4.0D)) {
/* 138 */       if (Animals.isFeedable(n))
...
/* 144 */             Animals.feed(n);
/* 145 */             ParticleEffect.HEART.display(((LivingEntity)n).getEyeLocation(), 0.2F, 0.2F, 0.2F, 0.0F, 8);
/*     */             return;
/*     */           } 
/*     */         }  
/*     */     } 
...
/* Location:              C:\Users\Administrator\Desktop\服务器2\server\plugins\Slimefun4_远古工艺 v4.1.15(不支持1.13+).jar!\me\mrCookieSlime\Slimefun\Objects\SlimefunItem\machines\AutoBreeder.class
